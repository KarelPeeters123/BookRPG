...
public class Pouch extends WornItem implements Equipable{
    public Pouch(String name, String description, int intelligence, int accuracy, int defense, int cooperation) {
    ...
    public Equipable unequip(Adventurer self) {
        if (!self.getEquipment().getPouch().equals(this)) {
